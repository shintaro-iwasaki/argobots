 ...
 * the output stream \c fp.  This routine is deprecated because it
 ...
 * some of the execution streams do not call \c ABT_xstream_check_events()
 ...
 * unless \c cb_func is \c NULL.  The first argument of \c cb_func() is set to
