...
struct ABTI_global {
    ...
    ABTI_mem_pool_global_pool
        mem_pool_thread_desc;                     /* Pool of ULT descriptors */
    ...
    ABTI_spinlock mem_pool_thread_desc_lock;
    ABTI_mem_pool_local_pool mem_pool_thread_desc_ext;
...
struct ABTI_xstream {
    ...
    ABTI_mem_pool_local_pool mem_pool_thread_desc;
